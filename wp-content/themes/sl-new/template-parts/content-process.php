...
<div class="process-container mx-auto">
    ...
    <?php endif; ?>
        ...
        <div class="process-text ph3 <?php the_field('process_text_height', $image['id']); ?>" style="<?php if (get_field('secondary_page_colour') ): ?> background-color: <?php the_field('secondary_page_colour'); ?>;<?php endif; ?>">
        <p>
